            ...
            <div className="p-4 sm:p-5">
                ...
                <div className="flex flex-wrap gap-2 mt-4">
                    <button
                        ...
                        className="btn-box-wa flex-1 min-w-[100px] px-3 py-2 text-xs sm:text-sm"
                    ...
                    <button
                        ...
                        className="btn-box-edit px-3 py-2 text-xs sm:text-sm"
                    ...
                    <button
                        ...
                        className="btn-box-read px-3 py-2 text-xs sm:text-sm"
                        title="Lihat Detail"
                    >
