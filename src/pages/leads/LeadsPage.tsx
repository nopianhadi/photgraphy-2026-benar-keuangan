            ...
            {isEmpty ? (
                ...
                <>
                    <div className="bg-brand-surface p-3 md:p-4 rounded-xl shadow-lg border border-brand-border flex flex-col lg:flex-row justify-between items-stretch lg:items-center gap-3 md:gap-4 leads-filter-section">
                        ...
                        <div className="flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center gap-2 sm:gap-3 w-full lg:w-auto leads-filter-row">
                            ...
                            <select value={sourceFilter} onChange={e => setSourceFilter(e.target.value as any)} className="input-field !rounded-lg !border !bg-brand-bg p-2 text-sm w-full sm:w-44 leads-source-filter">
