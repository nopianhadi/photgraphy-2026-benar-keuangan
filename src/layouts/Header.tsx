                ...
                <div className="header-brand-mobile" aria-hidden="true">
                    {profile?.logoBase64 ? (
                        <img
                            ...
                            loading="lazy"
                            decoding="async"
                            className="w-7 h-7 rounded-lg object-cover shadow-sm border border-brand-border/30"
                        />
                    ) : (
                        <img
                    ...
                    <span className="text-sm font-extrabold text-brand-text-light tracking-tight truncate">
